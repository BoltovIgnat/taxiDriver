            ...
            <div className="space-y-4">
              {CONTACTS.map((item) => (
                <BezelCard key={item.label} padding="sm">
                  ...
                  >
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-accent-soft text-xl text-[var(--color-steel)] transition-transform duration-500 ease-premium group-hover:scale-105">
