...
export const REVIEW_COPY = {
  alexeyMoscow: "Подключился за один день, взял авто в аренду без залога. За первый месяц вышло около 145 000 ₽ чистыми при графике 6/1. Выплаты каждый вечер на карту, без задержек.",
} as const;
